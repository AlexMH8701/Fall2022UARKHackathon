...
const challenge = require('./seek');
const board = require('./move');
let gameId;
let move;
...
exports.handler = Alexa.SkillBuilders.custom()
    .addRequestHandlers(
        ...
        chess_moveIntentHandler,
        chess_gameIntentHandler,
        HelpIntentHandler,
